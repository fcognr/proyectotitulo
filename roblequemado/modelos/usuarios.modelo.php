...
class ModeloUsuarios{
	...
	static public function mdlRegistroUsuario($tabla, $datos){
		...
		$stmt = Conexion::conectar()->prepare("INSERT INTO $tabla(nombre, apellido, password, email, telefono, modo, verificacion, email_encriptado, foto) VALUES (:nombre, :apellido, :password, :email, :telefono, :modo, :verificacion, :email_encriptado, :foto)");
