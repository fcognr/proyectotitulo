		...
		<div class="row">
			...
			<div class="col-12 col-lg-8 colIzqReservas p-0">
				...
				<div class="pt-4 headerReservas">
					...
					<?php else: ?>
						...
						<br>
						<a href="#modalLogin" data-toggle="modal" style="color:#FFCC29">Ver tus reservas</a>
			...
			<div class="col-12 col-lg-4 colDerReservas" style="display:none">
				...
				<div class="form-group">
				  ...
				  $galeria = json_decode($reservas[0]["galeria"], true); ?>
				...
				<div class="form-group">
				  ...
				  <select class="form-control horasTinaja">
					...
					<option value="<?php echo $precioTotal;?>, 0, Sin horas">No agregar </option>
					<option value="<?php echo $precioTotal;?>, 20000, 1 hora ">1 hora </option>
					<option value="<?php echo $precioTotal;?>, 36000, 2 horas">2 horas </option>
					<option value="<?php echo $precioTotal;?>, 45000, 3 horas">3 horas </option>
				  </select>
				...
				<div class="row py-4">
					...
					<div class="col-12 col-lg-6 col-xl-7 text-center text-lg-left">
						...
						<h1 class="precioTotal">$<span><?php echo number_format($precioTotal); ?></span> CLP</h1>
					...
					<?php if (isset($_SESSION["validarSesion"])): ?>
						...
						<?php if ($_SESSION["validarSesion"] == "ok"): ?>
						    ...
						    imgCabana="<?php echo $servidor.$galeria["0"]; ?>"
						    infoCabana="Cabaña <?php echo $reservas[0]["tipo"]; ?>"
						    horasTinaja="<?php echo $horaTinaja; ?>"
