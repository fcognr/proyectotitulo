...
<head>
	...
	<!-- Jquerynumber -->
	<script src="js/plugins/jquery.number.js"></script>
...
<div id="fb-root"></div>
<script async defer crossorigin="anonymous" src="https://connect.facebook.net/es_LA/sdk.js#xfbml=1&version=v17.0&appId=1020879865614661&autoLogAppEvents=1" nonce="eeXB4nbG"></script>
